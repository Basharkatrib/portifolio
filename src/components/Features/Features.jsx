    ...
    const data = [
        {
            ...
            subtitle: "2+ years of experience in developing full-stack web applications using React.js for frontend and Laravel for backend development.",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            title: "JavaScript & PHP Expert",
            subtitle: "Advanced proficiency in JavaScript (ES6+), React.js ecosystem, and PHP with Laravel framework for building scalable web applications.",
        },
        {
            id: 4,
            ...
            title: "React.js & Laravel Expert",
            subtitle: "Expert-level proficiency in React.js with hooks, context, Redux Toolkit, and Laravel with Eloquent ORM, Blade templates, and API development.",
        },
        {
            id: 5,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {data.map((card, index) => (
                        <motion.div
                            ...
                            key={card.id}
                        >
                            <div className="bg-zinc-900/50 backdrop-blur-sm p-6 rounded-xl shadow-2xl hover:shadow-red-500/10 transition-all duration-500 hover:-translate-y-2 border border-zinc-800/50 hover:border-red-500/20 sm:h-[300px]">
