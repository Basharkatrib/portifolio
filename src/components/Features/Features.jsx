...
function Features() {
    ...
    const data = [
        ...
        },
        {
            ...
            subtitle: t('features.cards.4.subtitle'),
        },
        {
            id: 5,
            ...
            subtitle: t('features.cards.5.subtitle'),
        },
        {
            id: 6,
            ...
            subtitle: t('features.cards.6.subtitle'),
        },
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {data.map((card, index) => (
                        <motion.div
                            ...
                            key={card.id}
                        >
                            <div className="bg-white/60 dark:bg-zinc-900/50 backdrop-blur-sm p-6 rounded-xl shadow-2xl hover:shadow-red-500/10 transition-all duration-500 hover:-translate-y-2 border border-zinc-200 dark:border-zinc-800/50 hover:border-red-500/20 sm:h-[300px]">
                                <div className="relative z-10">
                                    <div className="w-14 h-14 mb-6 p-3 bg-gradient-to-br from-red-600/15 to-red-500/5 rounded-lg group-hover:scale-110 transition-transform duration-300">
                                        {card.icon}
                                    </div>
                                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mb-4 group-hover:text-red-500 transition-colors duration-300">
                                        {card.title}
                                    </h3>
